...
import './XDDarkMyQR.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDDarkScan extends StatelessWidget {
  XDDarkScan({
    Key key,
  }) : super(key: key);
  @override
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(65.8, 10.5, 117.0, 27.0),
                      size: Size(182.8, 48.0),
                      pinRight: true,
                      fixedWidth: true,
                      fixedHeight: true,
