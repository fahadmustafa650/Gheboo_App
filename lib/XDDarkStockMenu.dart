...
import './XDDarkBuyStock.dart';
import './XDDarkStocks.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDDarkStockMenu extends StatelessWidget {
  XDDarkStockMenu({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_f7erce =
    '<svg viewBox="1.5 6.0 33.0 24.0" ><path  d="M 4.5 6 L 31.5 6 C 33.15685272216797 6 34.5 7.343145847320557 34.5 9 L 34.5 27 C 34.5 28.6568546295166 33.15685272216797 30 31.5 30 L 4.5 30 C 2.843145608901978 30 1.5 28.6568546295166 1.5 27 L 1.5 9 C 1.5 7.343145370483398 2.843146324157715 5.999999523162842 4.500000476837158 6 Z" fill="#aaaaaa" stroke="#fdfdfd" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" /></svg>';
const String _svg_2nlnyp =
    '<svg viewBox="1.5 15.0 33.0 1.0" ><path  d="M 1.5 15 L 34.5 15" fill="#aaaaaa" stroke="#fdfdfd" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" /></svg>';
