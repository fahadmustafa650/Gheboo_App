...
class XDDarkBitcoinGraph extends StatelessWidget {
  XDDarkBitcoinGraph({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(20.0, 1523.0),
            child: Container(
              width: 388.0,
              height: 216.0,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(21.0),
                color: const Color(0xb2004c68),
              ),
            ),
          ),
          Transform.translate(
            offset: Offset(36.0, 1539.0),
            child: Text(
              'About',
              style: TextStyle(
                fontFamily: 'Segoe UI',
          ...
          Transform.translate(
            offset: Offset(36.0, 1582.0),
            child: Text(
              'Bitcoin is a radically new way to store and\ntransact value. Unlike normal financial\nnetworks. Bitcoin is able to operate\nwithout central authorities or trusted\nadministrators. That makes bitcoin the\nfirst ever open and borderless currency. ',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 18,
          ...
          Transform.translate(
            offset: Offset(125.0, 1332.0),
            child: Text(
              '0.07400754 BTC Purchase',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 18,
                color: const Color(0xffffffff),
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(16.0, 0.0, 184.0, 32.0),
                    size: Size(200.0, 32.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
