...
class XDBrightRequest extends StatelessWidget {
  XDBrightRequest({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_glzy3u =
    '<svg viewBox="0.0 70.5 428.0 136.0" ><path transform="translate(0.0, 70.5)" d="M 0 0 L 428 0" fill="none" fill-opacity="0.5" stroke="#bebebe" stroke-width="2" stroke-opacity="0.5" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(0.0, 138.5)" d="M 0 0 L 428 0" fill="none" fill-opacity="0.5" stroke="#bebebe" stroke-width="2" stroke-opacity="0.5" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(0.0, 206.5)" d="M 0 0 L 428 0" fill="none" fill-opacity="0.5" stroke="#ffffff" stroke-width="2" stroke-opacity="0.5" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
